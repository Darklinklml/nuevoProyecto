...
<div class="container">
	...
	<form class="bg-white shadow rounded py-4 px-4" 
		...
		<div class="form-group">
			...
			<input class="form-control bg-light @error('precio_venta') is-valid @enderror shadow-sm "type="number" name="precio_venta" id="precio_venta" min="0" value="{{$videojuego->videojuego_precio_venta}}" required><br>
			@error('precio_venta')
